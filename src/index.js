...
class App extends React.Component {
  ...
  onDragUpdate = (update, provided) => {
    const message = update.destination ? `You have moved the task position ${update.destination.index + 1}` : `You are currently not over a droppable area`;
        ...
        <Droppable droppableId="all-columns" direction="horizontal" type="column">
          ...
          >
            {this.state.columnOrder.map((columnId, index) => {
              ...
              {/* return <Column key={column.id} column={column} index={index} tasks={tasks} isDropDisabled={isDropDisabled} />; */}
